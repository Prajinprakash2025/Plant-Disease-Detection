...
# Media files configuration (For uploading plant images)
MEDIA_URL = 'media/'
...
GEMINI_VOTE_COUNT = 1
USE_GEMINI_FOR_TRANSLATION = False
USE_GEMINI_FOR_TREATMENT_PLAN = True
FREE_TIER_LEAF_DIAGNOSIS_LIMIT = 20
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY")
if REQUIRE_GEMINI_FOR_LOW_CONFIDENCE and not GEMINI_API_KEY:
    raise Exception("GEMINI_API_KEY not set in environment")
LEAF_DIAGNOSIS_ALLOWED_EXTENSIONS = ['jpg', 'jpeg', 'png']
LEAF_DIAGNOSIS_MAX_UPLOAD_SIZE = 5 * 1024 * 1024
